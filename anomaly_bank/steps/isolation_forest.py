...
class IsolationForestPreprocess():
    ...
    def engineer_features(self):
        ...
        self.enriched_df, hashed_columns = features.hash_column(self.enriched_df, 'DeviceID', n_features=10)
        self.feat_columns.extend(hashed_columns)
